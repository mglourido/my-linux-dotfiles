...
import { TarjetaAjustes, TextoInformativo, TituloAjuste } from "../settings/componentes"
import { parseHypridle, writeHypridle, type HypridleConfig, type ListenerKind } from "../display/hypridle"

...
export namespace GstVideo {
     ...
     * @since 1.22
     */
    function buffer_add_video_sei_user_data_unregistered_meta(buffer: Gst.Buffer, uuid: Uint8Array | string, data: Uint8Array | null): VideoSEIUserDataUnregisteredMeta;
